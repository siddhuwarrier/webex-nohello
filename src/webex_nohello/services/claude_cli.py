...
The invocation is shaped by measurement rather than by documentation:
  ...
  * stdin MUST be closed. `claude -p` waits three seconds for piped input before giving up,
    which was most of the wall clock for a short prompt.
...
DEFAULT_MODEL = "haiku"
INSTALL_HINT = "Install Claude Code and sign in: https://docs.claude.com/en/docs/claude-code"
